					...
					<div class="panel-body">
						...
						<form name="MiForm" id="MiForm" method="post" action="cargar.php" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="button" name="submit" class="btn btn-primary"  value="Ver" onclick = "location='juegos.php'"/>
								<button name="submit" class="btn btn-success">Subir juego</button>
							</form>
						</section>
						<br>
						<br>
						<input type="text" name="" size="108" placeholder="Nombre del juego"><h1></h1>
