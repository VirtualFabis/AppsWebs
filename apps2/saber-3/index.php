			...
			<div class="row">
				...
				<div class="col-sm">
					...
					<div class="card  ">
						...
						<!-- Card image -->
						<div class="view overlay">
							<img class="card-img-top" src="images/saber2.png" height="120" 
							alt="Card image cap">
							<a href="#!">
								<div class="mask rgba-white-slight"></div>
							</a>
						...
						<div class="card-body">
							<!-- Title -->
							<p class="card-text">"El saber 2 de la materia Aplicaciones Web orientada a servicos"</p>
				...
				<div class="col-sm">
					...
					<div class="card  ">
						...
						<!-- Card image -->
						<div class="view overlay">
							<img class="card-img-top" src="images/saber3.png" height="120" 
							alt="Card image cap">
							<a href="#!">
								<div class="mask rgba-white-slight"></div>
							</a>
						...
						<div class="card-body">
							<!-- Title -->
							<p class="card-text">"El saber 3 de la materia Aplicaciones Web orientada a servicos"</p>

							<a href="indice3.php" class="btn btn-primary aqua-gradient">Ver mas</a>
						</div>
				...
				<div class="col-sm">
					...
					<div class="card">
						...
						<!-- Card image -->
						<div class="view overlay">
							<img class="card-img-top" src="images/13.png" height="150" alt="Card image cap">
							<a href="#!">
								<div class="mask rgba-white-slight"></div>
							</a>
						</div>
					...
					<!-- Card -->					</div>
						...
						<div class="col-sm">
							...
							<div class="card  ">
								...
								<!-- Card image -->
								<div class="view overlay">
									<img class="card-img-top" src="images/c.png" height="150" 
									alt="Card image cap">
									<a href="#!">
										<div class="mask rgba-white-slight"></div>
									</a>
