                    ...
                    <form class="form-horizontal" method="POST" action="?c=producto&a=Guardar">
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input required class="form-control" name="Nombre" type="number" placeholder="Codigo Producto" value="<?=$p->getPro_nom()?>">
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="Marca">Descripcion</label>
                          <div class="col-lg-10">
                            <input required class="form-control" name="Marca" type="text" placeholder="Descripcion" value="<?=$p->getPro_mar()?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="Cantidad">Stock</label>
                          <div class="col-lg-10">
