...
<header>
  ...
  <!-- Navbar -->
  <!-- Full Page Intro -->
  <div class="view" style="background-image: url('https://image.freepik.com/vector-gratis/estilo-abstracto-protector-pantalla-azul-clasico_23-2148437428.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
              ...
              <div class="card-body z-depth-2">
                ...
                <div class="text-center">
                  <h3 class="dark-grey-text">
                    <strong>Inicio de Sesión Administrador</strong>
                  </h3>
                  <hr>
                </div>
             <!-- Nav tabs -->
