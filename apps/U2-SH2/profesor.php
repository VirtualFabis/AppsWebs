...
<header>
  ...
  <!-- Navbar -->
  <!-- Full Page Intro -->
  <div class="view" style="background-image: url('https://image.freepik.com/vector-gratis/fondo-geometrico-azul-abstracto_23-2148594525.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
      ...
      <div class="container">
              ...
              <div class="card-body z-depth-2">
                ...
                <div class="text-center">
                  <h3 class="dark-grey-text">
                    <strong>Registro de los Profesores</strong>
                  </h3>
                  <hr>
                </div>
             <!-- Nav tabs -->
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade in show active" id="panel7" role="tabpanel">
            ...
            <!--Body-->
       <form method="POST" action="prof-re.php">

            <div class="modal-body mb-1">
              <div class="md-form form-sm mb-5">
              <i class="fas fa-fingerprint prefix"></i>
						<input type="number" id="inputValidationEx" class="form-control validate" name = "num_empleado" >
						<label for="inputValidationEx" data-error="wrong" data-success="right">No Empleado</label>
              </div>

              <div class="md-form form-sm mb-4">
               <i class="fas fa-user prefix"></i>
						<input type="text" id="inputValidationEx" class="form-control validate" name = "nombre" >
						<label for="inputValidationEx" data-error="wrong" data-success="right">Nombre con Apellido</label>
              </div>
