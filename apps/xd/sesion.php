...
<!-- Navbar -->
<!-- Full Page Intro -->
<div class="view" style="background-image: url('https://image.freepik.com/vector-gratis/protector-pantalla-moderno-gradiente-ondulado_79603-828.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
  ...
  <div class="mask rgba-indigo-strong d-flex justify-content-center align-items-center">
    ...
    <div class="container">
      ...
      <div class="row pt-lg-5 mt-lg-5">
        ...
        data-wow-delay="0.3s">
        <h1 class="display-4 font-weight-bold"> Smmart Safe Home</h1>
        <hr class="hr-light">
        <h6 class="mb-3">
        "Un pr-oyecto calidad presio para la seguridad del hogar"</h6>
