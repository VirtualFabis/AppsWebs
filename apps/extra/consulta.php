...
<div class="container">
    ...
    <center><img src="https://images.vexels.com/media/users/3/135251/isolated/preview/ab893f9074d536e3e940d61f0fc62b39-los-usuarios-firman-en-rojo-by-vexels.png" width="300"></center>
                                        <div class="card-body">
        <center><h4 class="card-title"><?php echo $consulta['nombre']; echo " ";?><?php echo $consulta['nsocio'];?></h4></center>
                                                <hr>
                                            </center>
                                            <center>
                                                ...
                                                <br><b>Género: </b><?php echo $consulta['ciudad'];?> <hr>
                                                <br><b>Fecha de Nacimiento: </b><?php echo $consulta['edad'];?> <hr>
